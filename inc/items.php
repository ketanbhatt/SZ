<?php 
	...
	$items[]=array(
		array(
			"name" => "Steel Bin",
			"desc" => "We are regarded as trustworthy Wholesale Supplier of Steel Bin in 
				New Delhi. We have a proficient team of quality analyst that tests Steel 
				Bin before dispatch to the customers. Our Steel Bin is rust-resistant and 
		...
		array(
			"name" => "Steel Laboratory Table",
			"desc" => "We are amidst reputed Wholesale Suppliers of Steel Laboratory Table 
	...
	$items[]=array(
		array(
			"name" => "",
			"desc" => "We are well-known as a noteworthy Wholesale Supplier of Kitchen Equipment in New Delhi. 
